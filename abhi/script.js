...
// 23.058959, 72.550073
// var marker = L.marker([23.058959, 72.550073]).addTo(map);
...
// // changes here by abhi
// var start = document.getElementById("para");
...
var marker = L.marker([Slat,Slon], {icon: carIcon}).addTo(map);
...
start.addEventListener("click",() => {
  navigator.geolocation.watchPosition(
      data => {
          ...
          console.log(data.coords.latitude),
          console.log(data.coords.longitude),
          L.marker([Slat,Slon],{icon: carIcon}).addTo(map)
      }
  ),(error) => console.log(error);
    })
...
// var marker = L.marker([23.058959, 72.550073],{
//   radius: 5,
//   fillColor: "red",
//   color: "#555",
//   weight: 1,
